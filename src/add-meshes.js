...
export default function (app) {
  ...
  // Island
  json = require('json!asset/island.json');
  ...
  // Clouds
  json = require('json!asset/cloud.json');
  geometry = loader.parse(json).geometry;
  ...
  // Forest
  json = require('json!asset/tree1.json');
  geometry = loader.parse(json).geometry;
  ...
  json = require('json!asset/tree2.json');
  geometry = loader.parse(json).geometry;
  ...
  // Tent
  json = require('json!asset/tent.json');
  geometry = loader.parse(json).geometry;
  ...
  // Fire
  json = require('json!asset/flame.json');
  geometry = loader.parse(json).geometry;
  ...
  json = require('json!asset/fire-base.json');
  geometry = loader.parse(json).geometry;
  ...
  // trunk
  json = require('json!asset/trunk.json');
  geometry = loader.parse(json).geometry;
  ...
  // rock
  json = require('json!asset/rock.json');
  geometry = loader.parse(json).geometry;
